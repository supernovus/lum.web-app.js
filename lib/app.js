...
class WebApp 
{
  ...
  constructor(options={})
  {
    ...
    const obsOpts = isObj(options.observable) ? options.observable : {};
   ...
   * trigger an event on this App instance, and all loaded extensions.
   * 
  ...
  triggerAll()
  {
    const trigRes = this.trigger(...arguments)
    const trigExt = this.triggerExt(...arguments);
    //console.debug({trigRes, trigExt, app: this});
    return this;
  }
