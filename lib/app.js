 ...
 * 
 * NOTE: Currently for all the `trigger*` methods
 * 
...
for (const sname of EV_PROTO_ALIASES)
{
...
/**
 * Register an event (as per `@lumjs/core.observable` API)
 * @function module:@lumjs/web-app/on
 * @param {(string|Symbol)} typeName - Event name/type
 * @param {function} listener - Event listener function
 */

/**
 * Alias to `trigger` (as added by the `core.observable()` API)
 * 
 * Unless the observable options used the `emit` method name,
 * in which case `trigger` will be an alias to `emit`.
 * 
 * Either way, both names will always point to the same method.
 * 
 * @function module:@lumjs/web-app/app.emit
 * @param {...any} [args]
 * @returns {object} `this`
 */
